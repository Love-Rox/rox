...
function getImportTables(): Array<{ name: string; schema: any; snakeCaseName: string }> {
  ...
  return [
    ...
    { name: "sessions", schema: schema.sessions, snakeCaseName: "sessions" },
    {
      ...
      schema: schema.passkeyCredentials,
      snakeCaseName: "passkey_credentials",
    },
    {
      name: "passkeyChallenges",
      schema: schema.passkeyChallenges,
      snakeCaseName: "passkey_challenges",
    },
    ...
    {
      name: "receivedActivities",
      schema: schema.receivedActivities,
      snakeCaseName: "received_activities",
    },
    ...
    { name: "invitationCodes", schema: schema.invitationCodes, snakeCaseName: "invitation_codes" },
    {
      ...
      schema: schema.instanceSettings,
      snakeCaseName: "instance_settings",
    },
    { name: "userReports", schema: schema.userReports, snakeCaseName: "user_reports" },
    {
      name: "moderationAuditLogs",
      schema: schema.moderationAuditLogs,
      snakeCaseName: "moderation_audit_logs",
    },
    ...
    { name: "notifications", schema: schema.notifications, snakeCaseName: "notifications" },
    {
      ...
      schema: schema.pushSubscriptions,
      snakeCaseName: "push_subscriptions",
    },
