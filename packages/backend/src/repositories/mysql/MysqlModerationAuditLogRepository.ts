/**
 * MySQL Moderation Audit Log Repository
 *
 * MySQL implementation of the IModerationAuditLogRepository interface.
 *
 * @module repositories/mysql/MysqlModerationAuditLogRepository
 */

import { eq, sql, desc, and } from "drizzle-orm";
import type { MySql2Database } from "drizzle-orm/mysql2";
import { moderationAuditLogs, type ModerationAuditLog } from "../../db/schema/mysql.js";
...
/**
 * MySQL implementation of Moderation Audit Log Repository
 */
export class MysqlModerationAuditLogRepository implements IModerationAuditLogRepository {
