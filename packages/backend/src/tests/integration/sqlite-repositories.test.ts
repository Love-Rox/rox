 ...
 *
 * Tests SQLite repository implementations with an actual in-memory SQLite database.
 * Uses Bun's built-in `bun:sqlite` driver (no native module required).
 *
 * Run with: bun test src/tests/integration/sqlite-repositories.test.ts
 */
