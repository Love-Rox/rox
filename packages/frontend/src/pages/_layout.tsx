...
import { generateIOSStartupImageLinks } from "../lib/ios-startup-images.js";
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      {/* iOS PWA Startup Images - displayed during PWA launch before HTML loads */}
      {/* These are dynamically generated by the backend based on device dimensions */}
      <span dangerouslySetInnerHTML={{ __html: generateIOSStartupImageLinks() }} />
